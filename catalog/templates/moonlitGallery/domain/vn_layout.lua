...
M.ART = { bg_w = 480, bg_h = 600, char_w = 280, char_h = 400 }
M.UI = {
...
function M.compute(ctx, visible_choices)
  ...
  -- XIC assets are native-size bitmaps on the device: draw portraits at their
  -- authored 280×400 size instead of requesting a firmware-unsupported scale.
  local char_w, char_h = M.ART.char_w, M.ART.char_h
